#%%
"""
Example of running a simulation in lumerical.
...
if __name__ == "__main__":
    tech_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "tech_lumerical.yaml")  # note materials definition format in yaml
